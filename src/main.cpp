...
const string strMessageMagic = "JuniorCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "JuniorCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "PszTimestamp";
        CTransaction txNew;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xdde80b74504b7df0eb138f0498619c49a1a9466cfbb24c231985cc8a47859248"));
        block.print();
